import { ISalesReportMetadata } from '@/types/sales-report-interface';

const SalesDataCard = ({
  salesReport,
}: {
  salesReport: ISalesReportMetadata;
}) => {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-5 text-sm font-medium">
      <div className="w-full px-4 py-4 bg-gradient-to-b from-[#FAFFFD] via-[#FFFDFA] to-[#FAFCFF] grid grid-cols-3 gap-5 shadow-sm rounded-lg text-sm font-medium">
        <div className="space-y-8 border-r border-gray-300 px-4 py-6">
          <div className="border-b pb-10 space-y-2">
            ...
            <article className="flex items-center gap-2">
              <p className="text-black text-xl font-semibold">
                {formatCurrency(salesReport?.total_sell_amount)}
              </p>
            </article>
          </div>
          <div className="space-y-2">
            ...
            <article className="flex items-center gap-2">
              <p className="text-black text-xl font-semibold">
                {formatCurrency(salesReport?.total_courier_cost)}
              </p>
            </article>
          </div>
        </div>
        <div className="space-y-8 border-r border-gray-300 px-4 py-6">
          <div className="border-b pb-10 space-y-2">
            ...
            <article className="flex items-center gap-2">
              <p className="text-black text-xl font-semibold">
                {formatCurrency(salesReport?.total_delivery_fee)}
              </p>
            </article>
          </div>
          <div className="space-y-2">
            ...
            <article className="flex items-center gap-2">
              <p className="text-black text-xl font-semibold">
                {formatCurrency(salesReport?.total_paid_amount)}
              </p>
            </article>
          </div>
        </div>
        <div className="space-y-8 py-6">
          <div className="border-b pb-10 space-y-2">
            ...
            <article className="flex items-center gap-2">
              <p className="text-black text-xl font-semibold">
                {formatCurrency(salesReport?.total_due_amount)}
              </p>
            </article>
          </div>
          <div className="space-y-2">
