...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-10 w-full items-center rounded-md justify-between border border-gray-300 bg-white px-3 py-2 text-sm text-gray-600 ring-offset-white placeholder:!text-gray-100 focus:outline-none focus:ring-1 focus:to-blue-950 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
      className,
    )}
    {...props}
  >
